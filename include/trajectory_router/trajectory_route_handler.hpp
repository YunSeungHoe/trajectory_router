#ifndef TRAJECTORY_ROUTER__TRAJECTORY_ROUTE_HANDLER_HPP_
#define TRAJECTORY_ROUTER__TRAJECTORY_ROUTE_HANDLER_HPP_
...
namespace trajectory_route_handler
{
...
class TrajectoryRouteHandler
{
public:
  TrajectoryRouteHandler() = default;
  explicit TrajectoryRouteHandler(const HADMapBin & map_msg);
...
private:
  ...
  rclcpp::Logger logger_{rclcpp::get_logger("trajectory_route_handler")};
...
#endif  // TRAJECTORY_ROUTER__TRAJECTORY_ROUTE_HANDLER_HPP_
